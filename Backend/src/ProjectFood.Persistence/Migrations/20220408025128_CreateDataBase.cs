    ...
    public partial class CreateDataBase : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", maxLength: 110, nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    ...
                    Email = table.Column<string>(type: "TEXT", maxLength: 127, nullable: true),
                    NormalizedEmail = table.Column<string>(type: "TEXT", maxLength: 127, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "TEXT", maxLength: 127, nullable: true),
                    NormalizedName = table.Column<string>(type: "TEXT", maxLength: 127, nullable: true),
                    ConcurrencyStamp = table.Column<string>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RoleId = table.Column<string>(type: "TEXT", maxLength: 127, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    UserId = table.Column<string>(type: "TEXT", maxLength: 110, nullable: false),
                    LoginProvider = table.Column<string>(type: "TEXT", maxLength: 110, nullable: false),
                    Name = table.Column<string>(type: "TEXT", maxLength: 110, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    NameImage = table.Column<string>(type: "TEXT", nullable: true),
